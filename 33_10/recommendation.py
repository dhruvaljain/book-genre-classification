...
tokens = nltk.word_tokenize(usertitle.decode('utf-8'))
...
#inputvec.append(tmp1)

#inputvec=np.asarray(inputvec)
...
result = []
for i in xrange(len(f_train)):
	result.append(1 - spatial.distance.cosine(f_train[i][0],tmp1))
